...
{
	//review: is this class needed?
	public class BaseMongoConnectionProvider : IMongoConnectionProvider
	{
		private readonly IMongoConfigProvider _configurationProvider;
		private readonly ILog _logger;

		public BaseMongoConnectionProvider(IMongoConfigProvider configurationProvider, ILog logger)
		{
		...
		public MongoServer Create(string appEnvironment)
		{
			...
			{
				_logger.DebugFormat("MongoDB Connection String: {0}", connectionString);
			}
